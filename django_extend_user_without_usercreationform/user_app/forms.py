...
class UserForm(forms.ModelForm):
    ...
    def clean(self):
        all_data = super(UserForm, self).clean()
        pass1 = all_data['password']
        pass2 = all_data['confirm_password']
        if pass1 and pass2:
            if pass1 != pass2:
    ...
    class Meta:
        model = User
        fields = ('first_name', 'last_name', 'email', 'phone_number', 'gender', 'username', 'password',
                  'confirm_password')
